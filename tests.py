...
testBox = box(150, 75, WIDTH/2 - 75, HEIGHT/2 - 37.25)
testPlayer = box(100, 25, WIDTH/2 - 50, HEIGHT - 50)

ball = box(10, 10, WIDTH/2 - 5, testPlayer.getY() + 10)
...
while running:
    ...
    ball.autoMove(SCREENDIM, 10, 10)
    if getSpriteCollision(ball, testBox) or getSpriteCollision(ball, testPlayer):
    	ball.switchDirs()
